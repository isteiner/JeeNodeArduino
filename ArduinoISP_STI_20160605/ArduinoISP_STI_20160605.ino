...
// 7: Heartbeat   - shows the programmer is running YELLOW
// 5: Error       - Lights up if something goes wrong (use red if that makes sense) RED
// 6: Programming - In communication with the slave GREEN
//
