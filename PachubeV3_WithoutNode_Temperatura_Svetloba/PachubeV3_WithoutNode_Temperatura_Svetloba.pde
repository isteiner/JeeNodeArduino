...
static char feedTemplate[] = "{\"version\":\"1.0.0\",\"datastreams\":[{\"id\":\"Temperatura\", \"current_value\":\"%s\"},{\"id\":\"Svetloba\",\"current_value\":\"%s\"}]}";
static char feedPost[FEED_POST_MAX_LENGTH] = {0}; // this will hold your filled out template

static char charBufSensorValue1[10] = {0};
static char charBufSensorValue2[10] = {0};  

uint8_t fillOutTemplateWithSensorValues(uint16_t node_id, float sensorValue1, float sensorValue2, float sensorValue3, float sensorValue4){
  ...
  dtostrf(sensorValue1, 7, 1, charBufSensorValue1);
  dtostrf(sensorValue2, 7, 1, charBufSensorValue2);
...
//snprintf(feedPost, FEED_POST_MAX_LENGTH, feedTemplate, sensorValue1, sensorValue2); // this simply populates the current_value filed with sensorValue1
  snprintf(feedPost, FEED_POST_MAX_LENGTH, feedTemplate, charBufSensorValue1, charBufSensorValue2); // this simply populates the current_value filed with sensorValue1
