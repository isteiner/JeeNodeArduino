...
/* for jeenode_1:
const char *devAddr = "260114AE";
const char *nwkSKey = "A2A5B6B1A51BC8CA598824CA1FF76FBC";
const char *appSKey = "2726EB2CA6E706BFFEDFB366C8310F93";
 */
...
static const PROGMEM u1_t APPSKEY[16] = {0x27, 0x26, 0xEB, 0x2C, 0xA6, 0xE7, 0x06, 0xBF, 0xFE, 0xDF, 0xB3, 0x66, 0xC8, 0x31, 0x0F, 0x93};   //{0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x00, 0xBE, 0x86};
static const PROGMEM u4_t DEVADDR = 0x260114AE;
#endif
