...
// change I. Steiner  20190606  changed serial configuration to Method 1 for BT Header, see https://lowpowerlab.com/forum/currentranger/currentranger-connection-to-imac-through-serial-header/
//                              baudrate 57600 bps
// *************************************************************************************************************
...
//***********************************************************************************************************
#define SERIALBAUD 57600      //Serial baud for HC-06 bluetooth output = 230400
#define BT_OUTPUT_NANOS        //ADC | AMPS | NANOS Change format of bluetooth data, canged by STI from BT_OUTPUT_AMPS 
...
byte BT_found=true;  // changed STI from false
...
/*
  // redirect of reading value to USB, see: https://lowpowerlab.com/forum/currentranger/currentranger-connection-to-imac-through-serial-header/ 
