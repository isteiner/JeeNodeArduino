...
//static char feedTemplate[] = "{\"version\":\"1.0.0\",\"datastreams\":[{\"id\":\"Temperatura\", \"current_value\":\"%d\"},{\"id\":\"Svetloba\",\"current_value\":\"%d\"}]}";
//static char feedTemplate[] = "{\"version\":\"1.0.0\",\"datastreams\":[{\"id\":\"Temperatura\", \"current_value\":\"%s\"},{\"id\":\"Svetloba\",\"current_value\":\"%d\"},{\"id\":\"Zun.temp\",\"current_value\":\"%s\"},{\"id\":\"Zun.vlaga\",\"current_value\":\"%d\"},{\"id\":\"Zun.svetloba\",\"current_value\":\"%d\"},{\"id\":\"Zun.gibanje\",\"current_value\":\"%d\"},{\"id\":\"LoBat\",\"current_value\":\"%d\"}]}";
...
/*
static char charBufSensorValue4[5] = {0};  
static char charBufSensorValue5[3] = {0};  
static char charBufSensorValue6[2] = {0};  
static char charBufSensorValue7[2] = {0};  
*/
...
//uint8_t fillOutTemplateWithSensorValues(uint16_t node_id, float sensorValue1, float sensorValue2, float sensorValue3, float sensorValue4, byte sensorValue5, byte sensorValue6, byte sensorValue7){
...
//snprintf(feedPost, FEED_POST_MAX_LENGTH, feedTemplate, charBufSensorValue1, charBufSensorValue2, charBufSensorValue3, payload.humi, payload.light, payload.moved, payload.lobat); 
...
/* 
  Serial.print("--- TEST float to string: ");
  Serial.println(charBufSensorValue1);
  Serial.println(charBufSensorValue2);
  
      Serial.print("**** POSLANO: ");
      Serial.print(sensorValue1, 1);
      Serial.print(", ");
      Serial.print(sensorValue2, 1);
      Serial.print(", ");
      Serial.print(sensorValue3, 1);
      Serial.print(", ");
      Serial.print(sensorValue4, 1);
      Serial.println();
 */ 
  return (1);
}
...
/*    
  ...
  */  
  ...
  if(currentTime - lastPostTimestamp > DELAY_BETWEEN_PACHUBE_POSTS_MS || firstTimeFlag){   
    firstTimeFlag = false;
 //   float sensorValue1 = analogRead(SENSOR1_ANALOG_PIN);
 //   float sensorValue2 = analogRead(SENSOR2_ANALOG_PIN);
 //   float sensorValue3 = analogRead(SENSOR3_ANALOG_PIN);
 //   float sensorValue4 = analogRead(SENSOR4_ANALOG_PIN);     
...
//  if(fillOutTemplateWithSensorValues(0, sensorValue1, sensorValue2, sensorValue3, sensorValue4, payload.light, payload.moved, payload.lobat)){    
...
//  Serial.print("Analog in reading: "); 
//  Serial.print(long(aRead));  
  // print brightness value on serial monitor 
//  Serial.print(" - Calculated Brightness: "); 
//  Serial.println(float(brightness),1); 
